...
export const ui = {
  es: {
    ...
    'hero.intro.p1': 'Como backend developer, trabajo en la',
    ...
    'hero.intro.p3': '→ Por eso creé mini proyectos educativos',
  ...
  en: {
    ...
    'hero.intro.p1': 'As a backend developer, I work in the',
    ...
    'hero.intro.p3': '→ That\'s why I created educational mini projects',
